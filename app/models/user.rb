class User < ApplicationRecord
  ...
  validates :user_name,uniqueness: true, presence: true, length: {maximum: 10}
  validates :mem_info, presence: true, length: {maximum: 30},uniqueness: true, format: { with: /\A[\w+\-.]+@[a-z\d\-.]+\.[a-z]+\z/i }
